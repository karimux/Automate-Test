...
*** Variables ***
${CONNECTIONFILE} =   		./TestData/TC_032_Authorise_created_loan_Tune_Loan/connexion.csv
${DATAFILE} =    			./TestData/TC_032_Authorise_created_loan_Tune_Loan/data.csv
${GLOBALFILE} =             ./TestData/data.csv

*** Test Cases ***
TC 032 Authorise created loan Tune Loan
    [Setup]
