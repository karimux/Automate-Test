...
*** Variables ***
${CONNECTIONFILE} =   		./TestData/TC_079_closure_DAT_without_charge/connexion.csv
${DATAFILE} =    			./TestData/TC_079_closure_DAT_without_charge/data.csv
${GLOBALFILE} =             ./TestData/data.csv

*** Test Cases ***
TC 079 closure DAT without charge
    [Setup]
    ...
    ${COL.OWNER} =    Select data in Global File    ${GLOBALFILE}    DAT.TO.CLOSE
